        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li>产品列表(共<span id="pageTotal">${page.total}</span>条记录)</li>
                </ul>
            </div>
        </div>
        ...
        <form id="listForm" action="list.jhtml" method="get">
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="clearfix">
                        <label>
                            <span style="margin-right: 15px;">产品名称</span>
                            <input type="text" class=" form-control input-sm" placeholder="产品名称" name="name"
                                   value="${search.name}"" style="width: 150px; display: inline-block; margin-right: 30px;">
                        </label>
                        <label>
                            <span style="margin-right: 15px;">产品分类</span>
                            <input type="text" class=" form-control input-sm" placeholder="产品分类" name="productId"
                                ...
                                <tbody>
	                                [#list page.content as product]
		                                <tr>
		                                    ...
		                                    <td>${product.price}</td>
		                                    <td>${product.stock}</td>
		                                    <td>[#if product.isMarketable]是[#else]否[/#if]</td>
		                                    <td>${product.createDate?string("yyyy-MM-dd")}</td>
		                                    <td>
		                                        <a href="#" class="btn btn-search"><i class="fa fa-search"></i>查看
		                                        </a>
		                                        <a href="edit.jhtml?id=${product.id}" class="btn btn-info"><i class="fa fa-pencil-square"></i>编辑
		                                        </a>
		                                    </td>
		                                </tr>
	                                [/#list]
