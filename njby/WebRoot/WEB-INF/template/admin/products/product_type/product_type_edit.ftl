                        ...
                        <form class="form-horizontal" id="inputForm" action="update.jhtml" method="post" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" name="name" value="${productType.name}" type="text" placeholder="名称" >
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select class="form-control input-sm" name="parentId">
                                  		[#list productTypeTree as category]
										...
										<!--
										[#list productTypeTree as category]
											[#if category != productType && !children?seq_contains(category)]
												<option value="${category.id}"[#if category == productType.parent] selected="selected"[/#if]>
													[#if category.grade != 0]
														[#list 1..category.grade as i]
															&nbsp;&nbsp;
														[/#list]
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" name="seo_title"  value="${productType.seoTitle}"  type="text" placeholder="页面标题" >
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" name="seo_keywords" value="${productType.seoKeywords}"  type="text" placeholder="页面关键词" >
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" name="seo_description"  value="${productType.seoDescription}" type="text" placeholder="页面描述">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" name="orders" value="${productType.orders}" type="text" placeholder="页面排序" >
                                </div>
                            </div>
                            <div class="form-group">
