        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li>留言列表(共<span id="pageTotal">${page.total}</span>条记录)</li>
                </ul>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="clearfix">
                        <label>
                            ...
                            <input type="text" class="form-control input-sm" placeholder="内容" name="content"
                                   value="${search.content}" style="width: 150px; display: inline-block; margin-right: 30px;">
                        </label>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-hover table-bordered" id="listTable">
                                ...
                                <tbody>
                                [#list page.content as leavemessage]
	                                <tr>
	                                    <td><input type="checkbox" name="ids" value="${leavemessage.id}"></td>
	                                    <td>${leavemessage.name}</td>
	                                    <td>${leavemessage.phone}</td>
	                                    <td>
	                                        <span title="">${leavemessage.title}</span>
	
	                                    </td>
	                                    <td>[#if leavemessage.isReaded]是[#else]否[/#if]</td>
	                                    <td>[#if leavemessage.isShowed]是[#else]否[/#if]</td>
	                                    <td>${leavemessage.createDate?string("yyyy-MM-dd")}</td>
	                                    <td>
	                                        <a href="#" class="btn btn-info"><i class="fa fa-pencil-square"></i>已读
	                                        </a>
	
	                                        <a href="#" class="btn btn-info"><i class="fa fa-pencil-square"></i>展示
	                                        </a>
