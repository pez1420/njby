                        ...
                        <form  class="form-horizontal" id="inputForm" action="update.jhtml" method="post" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" name="username" type="text" placeholder="用户名" value="${adminer.username}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" id="email" name="email"  placeholder="邮箱" value="${adminer.email}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 col-sm-2 control-label">角色</label>
                                <div class="col-md-6 col-sm-6">
                                    <select class="form-control input-sm" name="roleId">
                                        [#list roles as role]
                                        	<option value="${role.id}" [#if adminer.role.id == role.id] selected [/#if]>${role.name}</option>
  										[/#list]
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="checkbox" name="isEnabled" value="true" [#if adminer.isEnabled] checked="checked" [/#if] /> 是否启用
