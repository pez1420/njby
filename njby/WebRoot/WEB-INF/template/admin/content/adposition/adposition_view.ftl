        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li>广告位置列表(共<span id="pageTotal">${page.total}</span>条记录)</li>
                </ul>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="clearfix">
                        <label>
                            ...
                            <input  class="form-control input-sm" type="text" placeholder="名称"
                                   name="name" value="${search.name}" style="width: 150px; display: inline-block; margin-right: 30px;">
                        </label>
