                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" id="inputForm" action="save.jhtml" method="post" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
									<input class="form-control" name="width" type="text" placeholder="宽度">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" name="height" type="text" placeholder="高度">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
									<input class="form-control" name="description" type="text" placeholder="描述">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
									 <textarea name="template" style="width: 100%; height: 100px; padding: 0px;">
									 </textarea>
                                </div>
                            </div>
